...
// CVC_PATCH_REMOVED: 	ifnone
// CVC_PATCH_REMOVED: 	// comb arc A --> CO
// CVC_PATCH_REMOVED: 	 (A => CO) = (1.0,1.0);
...
// CVC_PATCH_REMOVED: 	ifnone
// CVC_PATCH_REMOVED: 	// comb arc B --> CO
// CVC_PATCH_REMOVED: 	 (B => CO) = (1.0,1.0);
...
// CVC_PATCH_REMOVED: 	ifnone
// CVC_PATCH_REMOVED: 	// comb arc CI --> CO
// CVC_PATCH_REMOVED: 	 (CI => CO) = (1.0,1.0);
...
// CVC_PATCH_REMOVED: 	ifnone
// CVC_PATCH_REMOVED: 	// comb arc posedge A --> (S:A)
// CVC_PATCH_REMOVED: 	 (posedge A => (S:A)) = (1.0,1.0);

// CVC_PATCH_REMOVED: 	ifnone
// CVC_PATCH_REMOVED: 	// comb arc negedge A --> (S:A)
// CVC_PATCH_REMOVED: 	 (negedge A => (S:A)) = (1.0,1.0);
...
// CVC_PATCH_REMOVED: 	ifnone
// CVC_PATCH_REMOVED: 	// comb arc posedge B --> (S:B)
// CVC_PATCH_REMOVED: 	 (posedge B => (S:B)) = (1.0,1.0);

// CVC_PATCH_REMOVED: 	ifnone
// CVC_PATCH_REMOVED: 	// comb arc negedge B --> (S:B)
// CVC_PATCH_REMOVED: 	 (negedge B => (S:B)) = (1.0,1.0);
...
// CVC_PATCH_REMOVED: 	ifnone
// CVC_PATCH_REMOVED: 	// comb arc posedge CI --> (S:CI)
// CVC_PATCH_REMOVED: 	 (posedge CI => (S:CI)) = (1.0,1.0);

// CVC_PATCH_REMOVED: 	ifnone
// CVC_PATCH_REMOVED: 	// comb arc negedge CI --> (S:CI)
// CVC_PATCH_REMOVED: 	 (negedge CI => (S:CI)) = (1.0,1.0);
...
// CVC_PATCH_REMOVED: 	ifnone
// CVC_PATCH_REMOVED: 	// comb arc B --> ZN
// CVC_PATCH_REMOVED: 	 (B => ZN) = (1.0,1.0);
...
// CVC_PATCH_REMOVED: 	ifnone
// CVC_PATCH_REMOVED: 	// comb arc A1 --> ZN
// CVC_PATCH_REMOVED: 	 (A1 => ZN) = (1.0,1.0);
...
// CVC_PATCH_REMOVED: 	ifnone
// CVC_PATCH_REMOVED: 	// comb arc A2 --> ZN
// CVC_PATCH_REMOVED: 	 (A2 => ZN) = (1.0,1.0);
...
// CVC_PATCH_REMOVED: 	ifnone
// CVC_PATCH_REMOVED: 	// comb arc B1 --> ZN
// CVC_PATCH_REMOVED: 	 (B1 => ZN) = (1.0,1.0);
...
// CVC_PATCH_REMOVED: 	ifnone
// CVC_PATCH_REMOVED: 	// comb arc B2 --> ZN
// CVC_PATCH_REMOVED: 	 (B2 => ZN) = (1.0,1.0);
...
// CVC_PATCH_REMOVED: 	ifnone
// CVC_PATCH_REMOVED: 	// comb arc C --> ZN
// CVC_PATCH_REMOVED: 	 (C => ZN) = (1.0,1.0);
...
// CVC_PATCH_REMOVED: 	ifnone
// CVC_PATCH_REMOVED: 	// comb arc C1 --> ZN
// CVC_PATCH_REMOVED: 	 (C1 => ZN) = (1.0,1.0);
...
// CVC_PATCH_REMOVED: 	ifnone
// CVC_PATCH_REMOVED: 	// comb arc C2 --> ZN
// CVC_PATCH_REMOVED: 	 (C2 => ZN) = (1.0,1.0);
...
// CVC_PATCH_REMOVED: 	ifnone
// CVC_PATCH_REMOVED: 	// seq arc RN --> Q
// CVC_PATCH_REMOVED: 	(RN => Q)  = (1.0,1.0);
...
// CVC_PATCH_REMOVED: 	ifnone
// CVC_PATCH_REMOVED: 	// seq arc SETN --> Q
// CVC_PATCH_REMOVED: 	(SETN => Q)  = (1.0,1.0);
...
// CVC_PATCH_REMOVED: 	ifnone
// CVC_PATCH_REMOVED: 	// comb arc CLKN --> Q
// CVC_PATCH_REMOVED: 	 (CLKN => Q) = (1.0,1.0);
...
// CVC_PATCH_REMOVED: 	ifnone
// CVC_PATCH_REMOVED: 	// comb arc CLK --> Q
// CVC_PATCH_REMOVED: 	 (CLK => Q) = (1.0,1.0);
...
// CVC_PATCH_REMOVED: 	ifnone
// CVC_PATCH_REMOVED: 	// comb arc I0 --> Z
// CVC_PATCH_REMOVED: 	 (I0 => Z) = (1.0,1.0);
...
// CVC_PATCH_REMOVED: 	ifnone
// CVC_PATCH_REMOVED: 	// comb arc I1 --> Z
// CVC_PATCH_REMOVED: 	 (I1 => Z) = (1.0,1.0);

// CVC_PATCH_REMOVED: 	ifnone
// CVC_PATCH_REMOVED: 	// comb arc posedge S --> (Z:S)
// CVC_PATCH_REMOVED: 	 (posedge S => (Z:S)) = (1.0,1.0);

// CVC_PATCH_REMOVED: 	ifnone
// CVC_PATCH_REMOVED: 	// comb arc negedge S --> (Z:S)
// CVC_PATCH_REMOVED: 	 (negedge S => (Z:S)) = (1.0,1.0);
...
// CVC_PATCH_REMOVED: 	ifnone
// CVC_PATCH_REMOVED: 	// comb arc I2 --> Z
// CVC_PATCH_REMOVED: 	 (I2 => Z) = (1.0,1.0);
...
// CVC_PATCH_REMOVED: 	ifnone
// CVC_PATCH_REMOVED: 	// comb arc I3 --> Z
// CVC_PATCH_REMOVED: 	 (I3 => Z) = (1.0,1.0);
...
// CVC_PATCH_REMOVED: 	ifnone
// CVC_PATCH_REMOVED: 	// comb arc posedge S0 --> (Z:S0)
// CVC_PATCH_REMOVED: 	 (posedge S0 => (Z:S0)) = (1.0,1.0);

// CVC_PATCH_REMOVED: 	ifnone
// CVC_PATCH_REMOVED: 	// comb arc negedge S0 --> (Z:S0)
// CVC_PATCH_REMOVED: 	 (negedge S0 => (Z:S0)) = (1.0,1.0);
...
// CVC_PATCH_REMOVED: 	ifnone
// CVC_PATCH_REMOVED: 	// comb arc posedge S1 --> (Z:S1)
// CVC_PATCH_REMOVED: 	 (posedge S1 => (Z:S1)) = (1.0,1.0);

// CVC_PATCH_REMOVED: 	ifnone
// CVC_PATCH_REMOVED: 	// comb arc negedge S1 --> (Z:S1)
// CVC_PATCH_REMOVED: 	 (negedge S1 => (Z:S1)) = (1.0,1.0);
...
// CVC_PATCH_REMOVED: 	ifnone
// CVC_PATCH_REMOVED: 	// comb arc A3 --> ZN
// CVC_PATCH_REMOVED: 	 (A3 => ZN) = (1.0,1.0);
...
// CVC_PATCH_REMOVED: 	ifnone
// CVC_PATCH_REMOVED: 	// comb arc B3 --> ZN
// CVC_PATCH_REMOVED: 	 (B3 => ZN) = (1.0,1.0);
...
// CVC_PATCH_REMOVED: 	ifnone
// CVC_PATCH_REMOVED: 	// seq arc CLK --> Q
// CVC_PATCH_REMOVED: 	(posedge CLK => (Q : D))  = (1.0,1.0);
...
// CVC_PATCH_REMOVED: 	ifnone
// CVC_PATCH_REMOVED: 	// comb arc posedge A1 --> (ZN:A1)
// CVC_PATCH_REMOVED: 	 (posedge A1 => (ZN:A1)) = (1.0,1.0);

// CVC_PATCH_REMOVED: 	ifnone
// CVC_PATCH_REMOVED: 	// comb arc negedge A1 --> (ZN:A1)
// CVC_PATCH_REMOVED: 	 (negedge A1 => (ZN:A1)) = (1.0,1.0);

// CVC_PATCH_REMOVED: 	ifnone
// CVC_PATCH_REMOVED: 	// comb arc posedge A2 --> (ZN:A2)
// CVC_PATCH_REMOVED: 	 (posedge A2 => (ZN:A2)) = (1.0,1.0);

// CVC_PATCH_REMOVED: 	ifnone
// CVC_PATCH_REMOVED: 	// comb arc negedge A2 --> (ZN:A2)
// CVC_PATCH_REMOVED: 	 (negedge A2 => (ZN:A2)) = (1.0,1.0);
...
// CVC_PATCH_REMOVED: 	ifnone
// CVC_PATCH_REMOVED: 	// comb arc posedge A3 --> (ZN:A3)
// CVC_PATCH_REMOVED: 	 (posedge A3 => (ZN:A3)) = (1.0,1.0);

// CVC_PATCH_REMOVED: 	ifnone
// CVC_PATCH_REMOVED: 	// comb arc negedge A3 --> (ZN:A3)
// CVC_PATCH_REMOVED: 	 (negedge A3 => (ZN:A3)) = (1.0,1.0);
...
// CVC_PATCH_REMOVED: 	ifnone
// CVC_PATCH_REMOVED: 	// comb arc posedge A1 --> (Z:A1)
// CVC_PATCH_REMOVED: 	 (posedge A1 => (Z:A1)) = (1.0,1.0);

// CVC_PATCH_REMOVED: 	ifnone
// CVC_PATCH_REMOVED: 	// comb arc negedge A1 --> (Z:A1)
// CVC_PATCH_REMOVED: 	 (negedge A1 => (Z:A1)) = (1.0,1.0);

// CVC_PATCH_REMOVED: 	ifnone
// CVC_PATCH_REMOVED: 	// comb arc posedge A2 --> (Z:A2)
// CVC_PATCH_REMOVED: 	 (posedge A2 => (Z:A2)) = (1.0,1.0);

// CVC_PATCH_REMOVED: 	ifnone
// CVC_PATCH_REMOVED: 	// comb arc negedge A2 --> (Z:A2)
// CVC_PATCH_REMOVED: 	 (negedge A2 => (Z:A2)) = (1.0,1.0);
...
// CVC_PATCH_REMOVED: 	ifnone
// CVC_PATCH_REMOVED: 	// comb arc posedge A3 --> (Z:A3)
// CVC_PATCH_REMOVED: 	 (posedge A3 => (Z:A3)) = (1.0,1.0);

// CVC_PATCH_REMOVED: 	ifnone
// CVC_PATCH_REMOVED: 	// comb arc negedge A3 --> (Z:A3)
// CVC_PATCH_REMOVED: 	 (negedge A3 => (Z:A3)) = (1.0,1.0);
