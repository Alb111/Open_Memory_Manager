...
module chip_top #(
    ...
    // Bidirectional pad used as Schmitt-trigger clock input.
    gf180mcu_fd_io__bi_24t clk_pad (
        `ifdef USE_POWER_PINS
        .DVDD   (VDD),
        .DVSS   (VSS),
        .VDD    (VDD),
    ...
    // Bidirectional pad used as reset input.
    gf180mcu_fd_io__bi_24t rst_n_pad (
        `ifdef USE_POWER_PINS
        .DVDD   (VDD),
        .DVSS   (VSS),
        .VDD    (VDD),
